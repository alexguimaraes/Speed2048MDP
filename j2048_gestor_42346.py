...
def regista_grelha_inicial(g11, g12, g13, g14,
    ...
    # inicializacao das restantes variaveis globais
    jogadas = ""
    pontos = None
...
def resgista_ranking():

    mensagem = None

    try:
        url_string = "http://ec2-54-246-213-131.eu-west-1.compute.amazonaws.com/cgi-bin/ submit_2048.py?numero=" + numero + "&amigos=" + amigos + "&jogadas=" + jogadas + "& pontos=" + str(pontos) + "&semente=" + str(semente)
...
def escreve_registo():
    ...
    mensagem_cloud = resgista_ranking()
